...
1. Utilice el siguiente listado de modelos de sensores comerciales para elaborar su actividad:
   ...
   - [x] 1.8 Sensor seguidor de pistas [TCRT5000](https://articulo.mercadolibre.com.mx/MLM-602097604-modulo-tcrt5000-sensor-optico-reflectivo-arduino-pic-_JM?quantity=1#position=1&type=item&tracking_id=6e9e4318-5969-4b28-a765-17a08bd5dc3f)
...
3. Una vez que conoce el tema a desarrollar, investigue y redacte dentro de este documento los puntos siguiente:
   ...
   - **Desarrollo**
    ...
    #### :page_facing_up: [Enlace directo a la presentacion.](https://github.com/CruzVeraEldenHumberto/Sistemas-Programables/blob/master/pdf/A1.3_Presentacion.pdf) :page_facing_up:

    :page_facing_up: Bibliografía: 

    [Definición de sensor óptico reflectivo](https://www.contrinex.com/es/product_family/photoelectric-reflex-4/)

    [Definición de TCRT5000](http://www.geekbotelectronics.com/producto/tcrt5000-sensor-optico-reflectivo/)

    [Datasheet del sensor TCRT5000](https://www.vishay.com/docs/83760/tcrt5000.pdf)

    [Características eléctricas del sensor TCRT5000](https://www.geekfactory.mx/tienda/sensores/tcrt5000-sensor-optico-reflectivo/)

    [Comportamiento del sensor TCRT5000](http://dyor.roboticafacil.es/seguilineas/)

    [Primer aplicación del sensor TCRT5000](https://www.robotshop.com/media/files/pdf/velleman-tcrt5000--line-tracking-sensor-datasheet.pdf)

    [Segunda aplicación del sensor TCRT5000](https://www.vishay.com/docs/83760/tcrt5000.pdf)
...
![Evidencia1](../img/A1.3_Evidencia1.png)

![Evidencia2](../img/A1.3_Evidencia2.png)

![Evidencia3](../img/A1.3_Evidencia3.png)
