...
![](../img/C3.2_Circuito.png)

2. Analice y escriba el programa que se muestra a continuación.

    Se puede observar que se le da un nombre al botón que esta conectado al pin digital 2. Luego se inicializa el botón como una entrada.

    Dentro del método loop se lee el estado del pin de entrada (en este caso el botón), después se imprime el estado del botón y se agrega un delay para que al accionar el botón varias veces no tenga problemas con leer su estado actual.
