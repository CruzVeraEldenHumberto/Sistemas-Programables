...
![](../img/C3.1_Circuito.png)

2. Analice y escriba el programa que se muestra a continuación.

    Lo que pude observar del código es que se inicializa un pin digital como salida, el cual está conectado a una resistencia y un led.

    Dentro del método loop se puede apreciar que digitalWrite recibe como parametro el pin y su estado, ya sea alto o bajo y existe un delay de 1 segundo entre cada cambio de estado. Como el código está dentro del método loop se va a repetir indefinidamente.
...
3. Explique el resultado observado.
   ...
   Se puede observar que el led se mantiene encendido por un segundo y después de ello se apaga por un segundo, esto se repite indefinidamente.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

![](../img/C3.1_Evidencia.png)
