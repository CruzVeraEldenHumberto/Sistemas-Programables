...
R= El propósito del microcontrolador en este sistema es el de activar el relé mediante una salida de 5V del microcontrolador, cuando se activa el relé se cierra el circuito y asi permite que se pueda accionar la electrovalvula.
Otros componentes electronicos son el relé y la electrovalvula.
